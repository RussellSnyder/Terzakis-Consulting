...
const linkClass = "text-xs sm:text-sm lg:text-base pt-2 w-full text-center border-t-2 border-orange-500 hover:border-t-4 hover:text-orange-500 hover:pt-1.5"
const activeClassName = 'border-t-4 border-black hover:text-black hover:pt-2'

export const Navbar = () => {
    return (
        <nav className="grid grid-cols-4 gap-2 sm:gap-4 lg:gap-8 justify-items-center">
